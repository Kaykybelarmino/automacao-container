...
sudo docker run --rm -v volume-mysql:/docker-entrypoint-initdb.d/ -w /docker-entrypoint-initdb.d/ busybox cp /home/ubuntu/automacao-container/script_formatadoV1.sql .
